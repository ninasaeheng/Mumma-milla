...
let productBundleArrows = {
  ...
  function handleBundleVariantChange(event) {
    ...
    try {
      ...
      const scriptElement = productForm.querySelector('script[type="application/json"]');
      ...
      if (currentVariant) {
        ...
        if (priceElement) {
          ...
          if (priceDisplay && typeof Shopify !== 'undefined' && typeof Shopify.formatMoney === 'function') {
            priceDisplay.textContent = Shopify.formatMoney(currentVariant.price, cartStrings?.money_format);
          }
        }
  ...
  function totalPrice() {
    try {
      ...
      if (typeof Shopify !== 'undefined' && typeof Shopify.formatMoney === 'function') {
        totalPriceElement.textContent = Shopify.formatMoney(totalPrice, cartStrings?.money_format);
      } else {
  ...
  function initProductBundle() {
    ...
    const firstVisibleProduct = document.querySelector('.pb__td_item:not(.hidden)');
    ...
    bundleProducts.forEach(product => {
      ...
      const scriptElement = product.querySelector('script[type="application/json"]');
      if (!scriptElement) {
      ...
      console.log("Processing product:", product.querySelector('.title')?.textContent);
      ...
      if (selectedOption) {
        ...
        const hasBottomSection = document.querySelector('.pb_bottom_detail') !== null;
        ...
        if (priceElement) {
          ...
          const priceDisplay = priceElement.querySelector('.price');
          if (priceDisplay && typeof Shopify !== 'undefined' && typeof Shopify.formatMoney === 'function') {
            priceDisplay.textContent = Shopify.formatMoney(selectedOption.price, cartStrings?.money_format);
          }
        }
      }
  ...
  async function initializeEverything() {
    ...
    try {
      ...
      const hasRequiredElements = document.querySelector('.pb__td_item') && 
